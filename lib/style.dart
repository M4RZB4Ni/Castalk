...
class Style  {
  ...
  static const Color cream = Color(0xffFFECBA);
  ...
  static Color gold29= const Color(0xffFFB800).withOpacity(0.29);
  ...
  static TextStyle t_500_24_lightGreen= const TextStyle(color: lightGreen,fontWeight: FontWeight.w500,fontSize: 24);
  ...
  static TextStyle t_700_20g= const TextStyle(color: accentGold,fontWeight: FontWeight.w700,fontSize: 20);
  ...
  static TextStyle t_500_24r=  TextStyle(color: redAccent,fontWeight: FontWeight.w500,fontSize: 24);
  ...
  static TextStyle t_500_12_g48_i= const TextStyle(color: gray48,fontWeight: FontWeight.w500,fontSize: 12,fontStyle: FontStyle.italic);
