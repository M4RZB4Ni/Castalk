...
_$_DownloadsModel _$$_DownloadsModelFromJson(Map<String, dynamic> json) =>
    _$_DownloadsModel(
...
Map<String, dynamic> _$$_DownloadsModelToJson(_$_DownloadsModel instance) =>
    <String, dynamic>{
      'data': instance.data,
    };
...
_$_EpisodeData _$$_EpisodeDataFromJson(Map<String, dynamic> json) =>
    _$_EpisodeData(
      episode: json['episode'] == null
          ? null
          : Data.fromJson(json['episode'] as Map<String, dynamic>),
    );
