...
class _$RegisterModelTearOff {
  ...
  _RegisterModel call({required String mobile}) {
...
/// @nodoc
@JsonSerializable()
class _$_RegisterModel extends _RegisterModel with DiagnosticableTreeMixin {
  _$_RegisterModel({required this.mobile}) : super._();
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'RegisterModel(mobile: $mobile)';
  }
...
abstract class _RegisterModel extends RegisterModel {
  factory _RegisterModel({required String mobile}) = _$_RegisterModel;
  _RegisterModel._() : super._();
