...
class Profile extends GetView<ProfileController> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Obx(() => controller.loadingProfile.value
          ? Scaffold(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: const Color(0xff80808080).withOpacity(0.5),
                            shape: BoxShape.rectangle,
                  ...
                  Padding(
                    ...
                    child: Align(
                        ...
                        child: Row(
                          children: [
                            ClipRRect(
                              child: Image.network("https://picsum.photos/96"),
                              borderRadius:
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                      controller.profileSingleList[0].username
                                          .toString(),
                          ...
                          children: [
                            ...
                            Text(
                                int.parse(controller
                                            .analyticsList[0].data!.listens!
                                            .toString()) <
                                        1000
                                    ? controller.analyticsList[0].data!.listens!
                                        .toString()
                                    : int.parse(controller
                                                .analyticsList[0].data!.listens!
                                                .toString()) >=
                                            1000
                                        ? controller.listensK.value
                                        : '',
                                style: Get.textTheme.headline1),
                          ],
                        )),
                    ...
                    child: Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                int.parse(controller
                                            .analyticsList[0].data!.followers!
                                            .toString()) <
                                        1000
                                    ? controller
                                        .analyticsList[0].data!.followers!
                                        .toString()
                                    : int.parse(controller.analyticsList[0]
                                                .data!.followers!
                                                .toString()) >=
                                            1000
                                        ? controller.followersK.value
                                        : '',
                                style: Get.textTheme.headline1),
                          ],
                        )),
                    ...
                    child: Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                int.parse(controller
                                            .analyticsList[0].data!.posts!
                                            .toString()) <
                                        1000
                                    ? controller.analyticsList[0].data!.posts!
                                        .toString()
                                    : int.parse(controller
                                                .analyticsList[0].data!.posts!
                                                .toString()) >=
                                            1000
                                        ? controller.postsK.value
                                        : '',
                                style: Get.textTheme.headline1),
                          ],
                        )),
                        ...
                        child: Row(
                            ...
                            children: [
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        top: 6, left: 6, bottom: 6),
                                    child: Container(
                                        width: 43,
                                        height: 43,
                                        child: SvgPicture.asset(
                                            svgPath + "playLists_golden.svg",
                              ...
                              Padding(
                                ...
                                child: Text(
                                  controller.playList.data!.playlists!.length
                                      .toString(),
                                  style: Get.textTheme.headline1!
              ...
              child: Column(
                  ...
                  children: [
                    SizedBox(
                      ...
                      height: 71,
                      child:
                          SvgPicture.asset(Cicon.logo, fit: BoxFit.scaleDown),
                    ), // Logo
                    Container(
                      margin: const EdgeInsets.only(top: 20),
                      width: 93,
                      height: 20,
                      child: SvgPicture.asset(svgPath + "castalk.svg",
                          fit: BoxFit.scaleDown),
                    ), // Castalk
                    Padding(
                    ...
                    InkWell(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(top: 20),
                        child: Text('Request Verify Badge',
                            style: Get.textTheme.headline1!
                                .copyWith(fontSize: 16)),
                      ),
                    ...
                    Padding(
                      ...
                      child: Text('App Settings',
                          style:
                              Get.textTheme.headline1!.copyWith(fontSize: 16)),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(top: 20),
